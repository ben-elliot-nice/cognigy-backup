...
echo "   git add -f config.json  # Force add (it's in .gitignore)"
echo "   git add ."
echo "   git commit -m 'Configure backup [skip-setup]'"
echo "3. Push to GitHub: git push"
echo "4. Add GitHub Secrets (in repository Settings → Secrets → Actions):"
